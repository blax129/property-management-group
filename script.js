(function () {
  ...
  const translations = {
    es: {
      ...
      "Private Property Management home": "Inicio de Private Property Management",
      ...
      "Private Property Management offers privately managed rental homes focused on transparency, responsive communication, and a smooth leasing experience.": "Private Property Management ofrece viviendas de alquiler administradas de forma privada, con enfoque en transparencia, comunicación receptiva y una experiencia de arrendamiento fluida.",
      ...
      "Meet Private Property Management": "Conozca a Private Property Management",
      ...
      "For rental inquiries or application support, contact Private Property Management directly.": "Para consultas sobre alquiler o apoyo con su solicitud, comuníquese directamente con Private Property Management.",
      "If you have questions regarding the application process, please contact Private Property Management directly.": "Si tiene preguntas sobre el proceso de solicitud, comuníquese directamente con Private Property Management.",
      "Email Private Property Management": "Enviar correo electrónico a Private Property Management",
      "Call Private Property Management": "Llamar a Private Property Management",
      "© 2026 Private Property Management": "© 2026 Private Property Management",
      "© 2026 Private Property Management.": "© 2026 Private Property Management",
      ...
      "Your application is marked as received. Please watch your email or phone for updates from Private Property Management about review status, tour scheduling, or next-step instructions.": "Su solicitud aparece como recibida. Revise su correo electrónico o teléfono para actualizaciones de Private Property Management sobre el estado de revisión, programación de visita o instrucciones de siguientes pasos.",
      ...
      "Contact Private Property Management": "Contactar a Private Property Management",
      ...
      "If you would prefer to email your payment confirmation instead, send it directly to Private Property Management for processing.": "Si prefiere enviar la confirmación de pago por correo, envíela directamente a Private Property Management para su procesamiento.",
      "Send Email Confirmation": "Enviar confirmación por correo",
      "Payment Confirmation Submitted": "Confirmación de pago enviada",
      "Your payment screenshot has been received and is pending private verification. Private Property Management will review your confirmation with your application details.": "Su captura de pantalla del pago fue recibida y está pendiente de verificación privada. Private Property Management revisará su confirmación junto con los detalles de su solicitud.",
    ...
    zh: {
      ...
      "Private Property Management offers privately managed rental homes focused on transparency, responsive communication, and a smooth leasing experience.": "Private Property Management 提供私人管理的出租住宅，注重透明沟通、及时回应和顺畅的租赁体验。",
      ...
      "Meet Private Property Management": "关于 Private Property Management",
      "Private Property Management is a dedicated property manager focused on providing organized, transparent, and professional rental support for property owners and prospective tenants.": "Private Property Management 是一位专注的私人物业经理，致力于为业主和潜在租户提供有条理、透明且专业的租赁支持。",
      "Private Property Management works closely with applicants throughout the rental process, helping them understand requirements, schedule property tours, and move through each step with clarity and confidence.": "Private Property Management 在整个租赁过程中与申请人密切合作，帮助他们了解申请要求、安排看房，并清晰自信地完成每一步。",
      "With a strong emphasis on communication, reliability, and professionalism, Private Property Management is committed to making the leasing experience smooth, well structured, and respectful for everyone involved.": "Private Property Management 高度重视沟通、可靠性和专业精神，致力于为所有相关人员营造顺畅、有序且相互尊重的租赁体验。",
      "HOA Logo": "HOA 标志",
      ...
      "Direct Contact": "直接联系",
      "For rental inquiries or application support, contact Private Property Management directly.": "如有关于租赁事宜或申请表协助的事项，请直接联系 Private Property Management。",
      "If you have questions regarding the application process, please contact Private Property Management directly.": "如对申请流程有任何疑问，请直接联系 Private Property Management。",
      "Email Private Property Management": "向 Private Property Management 发送电子邮件",
      "Call Private Property Management": "致电 Private Property Management",
      "© 2026 Private Property Management": "© 2026 Private Property Management",
      "© 2026 Private Property Management.": "© 2026 Private Property Management",
      ...
      "Your application is marked as received. Please watch your email or phone for updates from Private Property Management about review status, tour scheduling, or next-step instructions.": "您的申请已标记为收到。请留意电子邮件或电话，Private Property Management 将提供审核状态、看房安排或下一步说明。",
      ...
      "Return Home": "返回首页",
      "Contact Private Property Management": "联系 Private Property Management",
    ...
    fr: {
      ...
      "Private Property Management home": "Accueil Private Property Management",
      ...
      "Private Property Management offers privately managed rental homes focused on transparency, responsive communication, and a smooth leasing experience.": "Private Property Management propose des logements locatifs gérés en privé, avec transparence, communication réactive et expérience de location fluide.",
      ...
      "Meet Private Property Management": "À propos de Private Property Management",
      "Private Property Management is a dedicated property manager focused on providing organized, transparent, and professional rental support for property owners and prospective tenants.": "Private Property Management est un gestionnaire privé de propriétés dévoué, axé sur un accompagnement locatif organisé, transparent et professionnel pour les propriétaires comme pour les futurs locataires.",
      "Private Property Management works closely with applicants throughout the rental process, helping them understand requirements, schedule property tours, and move through each step with clarity and confidence.": "Private Property Management travaille étroitement avec les candidats tout au long du processus de location, les aidant à comprendre les exigences de demande, à planifier les visites et à avancer à chaque étape avec clarté et confiance.",
      "With a strong emphasis on communication, reliability, and professionalism, Private Property Management is committed to making the leasing experience smooth, well structured, and respectful for everyone involved.": "Avec une forte priorité donnée à la communication, à la fiabilité et au professionnalisme, Private Property Management s’engage à créer une expérience de location fluide, bien structurée et respectueuse pour toutes les personnes impliquées.",
      "HOA Logo": "Logo HOA",
      ...
      "For rental inquiries or application support, contact Private Property Management directly.": "Pour toute demande liée à la location ou au dossier de candidature, vous pouvez contacter Private Property Management directement.",
      "If you have questions regarding the application process, please contact Private Property Management directly.": "Pour toute question sur le déroulement de la candidature, veuillez contacter Private Property Management directement.",
      "Email Private Property Management": "Envoyer un e-mail à Private Property Management",
      "Call Private Property Management": "Appeler Private Property Management",
      "© 2026 Private Property Management": "© 2026 Private Property Management",
      "© 2026 Private Property Management.": "© 2026 Private Property Management",
      ...
      "Your application is marked as received. Please watch your email or phone for updates from Private Property Management about review status, tour scheduling, or next-step instructions.": "Votre demande est marquée comme reçue. Surveillez votre e-mail ou téléphone pour les mises à jour de Private Property Management concernant l’examen, les visites ou les prochaines étapes.",
      ...
      "Contact Private Property Management": "Contacter Private Property Management",
    ...
    pt: {
      ...
      "Private Property Management offers privately managed rental homes focused on transparency, responsive communication, and a smooth leasing experience.": "Private Property Management oferece imóveis de aluguel administrados de forma privada, com foco em transparência, comunicação rápida e uma experiência de locação tranquila.",
      ...
      "Meet Private Property Management": "Sobre Private Property Management",
      "Private Property Management is a dedicated property manager focused on providing organized, transparent, and professional rental support for property owners and prospective tenants.": "Private Property Management é um administrador privado de propriedades dedicado a oferecer suporte de aluguel organizado, transparente e profissional para proprietários e possíveis inquilinos.",
      "Private Property Management works closely with applicants throughout the rental process, helping them understand requirements, schedule property tours, and move through each step with clarity and confidence.": "Private Property Management trabalha de perto com os candidatos durante todo o processo de locação, ajudando-os a entender os requisitos da solicitação, agendar visitas ao imóvel e avançar em cada etapa com clareza e confiança.",
      "With a strong emphasis on communication, reliability, and professionalism, Private Property Management is committed to making the leasing experience smooth, well structured, and respectful for everyone involved.": "Com forte ênfase em comunicação, confiabilidade e profissionalismo, Private Property Management se compromete a criar uma experiência de aluguel tranquila, bem estruturada e respeitosa para todos os envolvidos.",
      "HOA Logo": "Logo HOA",
      ...
      "For rental inquiries or application support, contact Private Property Management directly.": "Para dúvidas sobre aluguel ou apoio com sua candidatura, entre em contato diretamente com Private Property Management.",
      "If you have questions regarding the application process, please contact Private Property Management directly.": "Em caso de dúvidas sobre o processo de solicitação, entre em contato diretamente com Private Property Management.",
      "Email Private Property Management": "Enviar e-mail para Private Property Management",
      "Call Private Property Management": "Ligar para Private Property Management",
      "© 2026 Private Property Management": "© 2026 Private Property Management",
      "© 2026 Private Property Management.": "© 2026 Private Property Management",
      ...
      "Your application is marked as received. Please watch your email or phone for updates from Private Property Management about review status, tour scheduling, or next-step instructions.": "Sua solicitação foi marcada como recebida. Verifique seu e-mail ou telefone para atualizações de Private Property Management sobre análise, visitas ou próximos passos.",
      ...
      "Contact Private Property Management": "Contatar Private Property Management",
    ...
    ar: {
      ...
      "Private Property Management home": "الصفحة الرئيسية لـ Private Property Management",
      ...
      "Private Property Management offers privately managed rental homes focused on transparency, responsive communication, and a smooth leasing experience.": "تقدم Private Property Management منازل إيجار بإدارة خاصة تركز على الشفافية والتواصل السريع وتجربة تأجير سلسة.",
      ...
      "Meet Private Property Management": "نبذة عن Private Property Management",
      "Private Property Management is a dedicated property manager focused on providing organized, transparent, and professional rental support for property owners and prospective tenants.": "Private Property Management مدير عقارات خاص متفانٍ يركز على تقديم دعم إيجاري منظم وشفاف ومهني لكل من مالكي العقارات والمستأجرين المحتملين.",
      "Private Property Management works closely with applicants throughout the rental process, helping them understand requirements, schedule property tours, and move through each step with clarity and confidence.": "Private Property Management يعمل عن قرب مع المتقدمين طوال عملية التأجير، ويساعدهم على فهم متطلبات الطلب وجدولة جولات العقار والتنقل في كل خطوة بوضوح وثقة.",
      "With a strong emphasis on communication, reliability, and professionalism, Private Property Management is committed to making the leasing experience smooth, well structured, and respectful for everyone involved.": "مع تركيز قوي على التواصل والموثوقية والمهنية، تلتزم Private Property Management بخلق تجربة إيجار سلسة ومنظمة ومحترمة لجميع الأطراف.",
      "HOA Logo": "شعار HOA",
      ...
      "For rental inquiries or application support, contact Private Property Management directly.": "للاستفسارات عن الإيجار أو الدعم بخصوص الطلب، يمكنكم التواصل مع Private Property Management مباشرةً.",
      "If you have questions regarding the application process, please contact Private Property Management directly.": "إذا كان لديكم أي أسئلة بشأن عملية التقديم، يُرجى التواصل مباشرةً مع Private Property Management.",
      "Email Private Property Management": "مراسلة Private Property Management عبر البريد الإلكتروني",
      "Call Private Property Management": "الاتصال بـ Private Property Management",
      "© 2026 Private Property Management": "© 2026 Private Property Management",
      "© 2026 Private Property Management.": "© 2026 Private Property Management",
      ...
      "Your application is marked as received. Please watch your email or phone for updates from Private Property Management about review status, tour scheduling, or next-step instructions.": "تم وضع علامة على طلبك كطلب مستلم. يرجى متابعة بريدك الإلكتروني أو هاتفك للحصول على تحديثات من Private Property Management حول حالة المراجعة أو جدولة الجولة أو تعليمات الخطوة التالية.",
      ...
      "Contact Private Property Management": "التواصل مع Private Property Management",
  ...
  const aliases = {
    ...
    "Inicio de Private Property Management": "Private Property Management home",
    "Idioma": "Language",
    ...
    "Private Property Management ofrece viviendas de alquiler administradas de forma privada, con enfoque en transparencia, comunicación receptiva y una experiencia de arrendamiento fluida.": "Private Property Management offers privately managed rental homes focused on transparency, responsive communication, and a smooth leasing experience.",
    ...
    "Conozca a Private Property Management": "Meet Private Property Management",
    "Private Property Management es un administrador de propiedades dedicado a brindar apoyo de alquiler organizado, transparente y profesional para propietarios y posibles inquilinos.": "Private Property Management is a dedicated property manager focused on providing organized, transparent, and professional rental support for property owners and prospective tenants.",
    ...
    "Para consultas sobre alquiler o apoyo con su solicitud, comuníquese directamente con Private Property Management.": "For rental inquiries or application support, contact Private Property Management directly.",
    "Si tiene preguntas sobre el proceso de solicitud, comuníquese directamente con Private Property Management.": "If you have questions regarding the application process, please contact Private Property Management directly.",
    "Enviar correo electrónico a Private Property Management": "Email Private Property Management",
    "Llamar a Private Property Management": "Call Private Property Management",
    "© 2026 Private Property Management. Alquileres administrados de forma privada.": "© 2026 Private Property Management",
    "© 2026 Private Property Management.": "© 2026 Private Property Management",
    ...
    "Su solicitud aparece como recibida. Revise su correo electrónico o teléfono para actualizaciones de Private Property Management sobre el estado de revisión, programación de visita o instrucciones de siguientes pasos.": "Your application is marked as received. Please watch your email or phone for updates from Private Property Management about review status, tour scheduling, or next-step instructions.",
    ...
    "Contactar a Private Property Management": "Contact Private Property Management",
  ...
  const postFlowTranslations = {
    es: {
      ...
      "For any questions, clarification, or verification regarding the application process, you can contact Private Property Management directly using the information below.": "Para preguntas, aclaraciones o verificación sobre el proceso de solicitud, puede contactar directamente a Private Property Management usando la información siguiente.",
      ...
      "If you have already received assigned payment instructions and would prefer to email your payment confirmation instead, send it directly to Private Property Management for private verification.": "Si ya recibió instrucciones de pago asignadas y prefiere enviar su confirmación de pago por correo, envíela directamente a Private Property Management para verificación privada.",
      "Send Email Verification": "Enviar verificación por correo",
      "Payment Verification Submitted": "Verificación de pago enviada",
      "Your payment confirmation screenshot has been received for private verification. Private Property Management will review it with your Application ID and assigned payment processing instructions.": "Su captura de pantalla de confirmación de pago fue recibida para verificación privada. Private Property Management la revisará con su ID de solicitud y las instrucciones de procesamiento de pago asignadas.",
    ...
    fr: {
      ...
      "For any questions, clarification, or verification regarding the application process, you can contact Private Property Management directly using the information below.": "Pour toute question, précision ou vérification concernant le processus de demande, vous pouvez contacter Private Property Management directement avec les coordonnées ci-dessous.",
      "Email:": "E-mail :",
      "Phone:": "Téléphone :",
      ...
      "If you would prefer to email your payment confirmation instead, send it directly to Private Property Management for processing.": "Si vous préférez envoyer votre confirmation de paiement par e-mail, adressez-la directement à Private Property Management pour traitement.",
      ...
      "Your payment screenshot has been received and is pending private verification. Private Property Management will review your confirmation with your application details.": "Votre capture d’écran de paiement a été reçue et est en attente de vérification privée. Private Property Management l’examinera avec les détails de votre demande.",
    ...
    pt: {
      ...
      "For any questions, clarification, or verification regarding the application process, you can contact Private Property Management directly using the information below.": "Para dúvidas, esclarecimentos ou verificação sobre o processo de solicitação, entre em contato diretamente com Private Property Management usando as informações abaixo.",
      "Email:": "E-mail:",
      "Phone:": "Telefone:",
      ...
      "If you would prefer to email your payment confirmation instead, send it directly to Private Property Management for processing.": "Se preferir enviar a confirmação de pagamento por e-mail, envie diretamente para Private Property Management para processamento.",
      "Send Email Confirmation": "Enviar confirmação por e-mail",
      "Payment Confirmation Submitted": "Confirmação de pagamento enviada",
      "Your payment screenshot has been received and is pending private verification. Private Property Management will review your confirmation with your application details.": "Sua captura de tela do pagamento foi recebida e está pendente de verificação privada. Private Property Management analisará sua confirmação junto com os detalhes da solicitação.",
    ...
    zh: {
      ...
      "For any questions, clarification, or verification regarding the application process, you can contact Private Property Management directly using the information below.": "如需咨询、说明或核实申请流程，您可以使用以下信息直接联系 Private Property Management。",
      "Email:": "电子邮件：",
      "Phone:": "电话：",
      ...
      "If you would prefer to email your payment confirmation instead, send it directly to Private Property Management for processing.": "如果您更愿意通过电子邮件发送付款确认，请直接发送给 Private Property Management 处理。",
      "Send Email Confirmation": "发送电子邮件确认",
      "Payment Confirmation Submitted": "付款确认已提交",
      "Your payment screenshot has been received and is pending private verification. Private Property Management will review your confirmation with your application details.": "您的付款截图已收到，目前等待私下核验。Private Property Management 将结合您的申请详情审核该确认。",
    ...
    ar: {
      ...
      "For any questions, clarification, or verification regarding the application process, you can contact Private Property Management directly using the information below.": "لأي أسئلة أو توضيحات أو للتحقق من عملية الطلب، يمكنك التواصل مباشرة مع Private Property Management باستخدام المعلومات أدناه.",
      ...
      "If you would prefer to email your payment confirmation instead, send it directly to Private Property Management for processing.": "إذا كنت تفضل إرسال تأكيد الدفع عبر البريد الإلكتروني، فأرسله مباشرة إلى Private Property Management لمعالجته.",
      "Send Email Confirmation": "إرسال التأكيد عبر البريد الإلكتروني",
      "Payment Confirmation Submitted": "تم إرسال تأكيد الدفع",
      "Your payment screenshot has been received and is pending private verification. Private Property Management will review your confirmation with your application details.": "تم استلام لقطة شاشة الدفع وهي بانتظار التحقق الخاص. ستراجع Private Property Management التأكيد مع تفاصيل طلبك.",
  ...
  const workflowTranslations = {
    ...
    zh: {
      ...
      "If you have already received assigned payment instructions and would prefer to email your payment confirmation instead, send it directly to Private Property Management for private verification.": "如果您已收到分配的付款说明，并希望通过电子邮件发送付款确认，请直接发送给 Private Property Management 进行私下验证。",
      "Send Email Verification": "发送电子邮件验证",
      "Payment Verification Submitted": "付款验证已提交",
      "Your payment confirmation screenshot has been received for private verification. Private Property Management will review it with your Application ID and assigned payment processing instructions.": "您的付款确认截图已收到，将用于私下验证。Private Property Management 会结合您的申请编号和分配的付款处理说明进行审核。",
    ...
    fr: {
      ...
      "If you have already received assigned payment instructions and would prefer to email your payment confirmation instead, send it directly to Private Property Management for private verification.": "Si vous avez déjà reçu des instructions de paiement attribuées et préférez envoyer votre confirmation par e-mail, adressez-la directement à Private Property Management pour une vérification privée.",
      ...
      "Your payment confirmation screenshot has been received for private verification. Private Property Management will review it with your Application ID and assigned payment processing instructions.": "Votre capture d’écran de confirmation de paiement a été reçue pour vérification privée. Private Property Management l’examinera avec votre ID de demande et les instructions de traitement du paiement attribuées.",
    ...
    ar: {
      ...
      "If you have already received assigned payment instructions and would prefer to email your payment confirmation instead, send it directly to Private Property Management for private verification.": "إذا كنت قد تلقيت بالفعل تعليمات دفع مخصصة وتفضل إرسال تأكيد الدفع عبر البريد الإلكتروني، فأرسله مباشرة إلى Private Property Management للتحقق الخاص.",
      "Send Email Verification": "إرسال التحقق عبر البريد الإلكتروني",
      "Payment Verification Submitted": "تم إرسال التحقق من الدفع",
      "Your payment confirmation screenshot has been received for private verification. Private Property Management will review it with your Application ID and assigned payment processing instructions.": "تم استلام لقطة شاشة تأكيد الدفع للتحقق الخاص. ستراجعها Private Property Management مع رقم طلبك وتعليمات معالجة الدفع المخصصة.",
  ...
  const applicationTrustTranslations = {
    es: {
      ...
      "Please note that a refundable $75 application fee is required before the approval process can begin.": "Tenga en cuenta que se requiere una tarifa de solicitud reembolsable de $75 antes de que pueda comenzar el proceso de aprobación.",
      "Once the payment has been confirmed, your application review and approval process will officially commence.": "Una vez confirmado el pago, comenzará oficialmente el proceso de revisión y aprobación de su solicitud.",
      "Your submission is being reviewed for completeness and next-step fit. Private Property Management will contact you directly if more information, tour scheduling, or a refundable fee step is needed.": "Su solicitud se está revisando para confirmar que esté completa y definir los próximos pasos. Private Property Management se comunicará directamente si se necesita más información, programar una visita o un paso de tarifa reembolsable.",
      ...
      "Do not send payment unless Private Property Management has provided instructions for your application.": "No envíe ningún pago a menos que Private Property Management le haya proporcionado instrucciones para su solicitud.",
      ...
      "If you want to confirm a message, ask about timing, or clarify the application process, contact Private Property Management directly using the information below.": "Si desea confirmar un mensaje, preguntar sobre tiempos o aclarar el proceso de solicitud, contacte directamente a Private Property Management usando la información siguiente.",
      "Payment Verification": "Verificación de pago",
      "Use this page only if Private Property Management has already provided payment instructions for your application. Upload a confirmation screenshot after completing that assigned step.": "Use esta página solo si Private Property Management ya le proporcionó instrucciones de pago para su solicitud. Suba una captura de confirmación después de completar ese paso asignado.",
      ...
      "If you have already received instructions and prefer email, you can send the confirmation directly to Private Property Management for review.": "Si ya recibió instrucciones y prefiere usar correo electrónico, puede enviar la confirmación directamente a Private Property Management para revisión.",
  ...
  Object.assign(aliases, {
    ...
    "Su solicitud se está revisando para confirmar que esté completa y definir los próximos pasos. Private Property Management se comunicará directamente si se necesita más información, programar una visita o un paso de tarifa reembolsable.": "Your submission is being reviewed for completeness and next-step fit. Private Property Management will contact you directly if more information, tour scheduling, or a refundable fee step is needed.",
    ...
    "No envíe ningún pago a menos que Private Property Management le haya proporcionado instrucciones para su solicitud.": "Do not send payment unless Private Property Management has provided instructions for your application.",
    ...
    "Si desea confirmar un mensaje, preguntar sobre tiempos o aclarar el proceso de solicitud, contacte directamente a Private Property Management usando la información siguiente.": "If you want to confirm a message, ask about timing, or clarify the application process, contact Private Property Management directly using the information below.",
    "Verificación de pago": "Payment Verification",
    "Use esta página solo si Private Property Management ya le proporcionó instrucciones de pago para su solicitud. Suba una captura de confirmación después de completar ese paso asignado.": "Use this page only if Private Property Management has already provided payment instructions for your application. Upload a confirmation screenshot after completing that assigned step.",
    ...
    "Si ya recibió instrucciones y prefiere usar correo electrónico, puede enviar la confirmación directamente a Private Property Management para revisión.": "If you have already received instructions and prefer email, you can send the confirmation directly to Private Property Management for review.",
    ...
    "Para preguntas, aclaraciones o verificación sobre el proceso de solicitud, puede contactar directamente a Private Property Management usando la información siguiente.": "For any questions, clarification, or verification regarding the application process, you can contact Private Property Management directly using the information below.",
  ...
  function collectApplicationAdminEmailParams(form, applicationId) {
    ...
    return {
      ...
      subject: applicantName
        ...
        : "New Rental Application - Private Property Management",
